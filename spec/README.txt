...
Arva Build Tool 		-- Reads the package.yaml file, locates the dependencies, and links the program.
...
"/spec/overview.md" serves as an introduction to the language and illustrates arva in action. It links to other parts of the specification for refrence.
